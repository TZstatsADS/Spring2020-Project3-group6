...
```{r final_train_svm}
source("../lib/train_svm2.R")
par_best=NULL
fit_train_svm2 <- train(dat_train, tuned_parameters$best.parameters)
save(fit_train_svm2, file="../output/fit_train_svm2.RData")
```

* evaluation: train accuracy
```{r}
source("../lib/train_svm2.R")
load("../output/fit_train_svm2.RData")
if(run.test){
...
```{r test_svm2}
source("../lib/test_svm2.R")
tm_test=NA
if(run.test){
  load(file="../output/fit_train_svm2.RData")
...
cat("The accuracy of model:", "is", test_accuracy*100, "%.\n")
library(caret)
